...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Listing.attributeGroup'
        db.add_column('listings_listing', 'attributeGroup',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Listing.attributeGroup'
        db.delete_column('listings_listing', 'attributeGroup')
