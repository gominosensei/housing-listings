...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FreshListing.listingType'
        db.delete_column('listings_freshlisting', 'listingType')

        # Adding field 'FreshListing.url'
        db.add_column('listings_freshlisting', 'url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=254, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FreshListing.listingType'
        db.add_column('listings_freshlisting', 'listingType',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3),
                      keep_default=False)

        # Deleting field 'FreshListing.url'
        db.delete_column('listings_freshlisting', 'url')
