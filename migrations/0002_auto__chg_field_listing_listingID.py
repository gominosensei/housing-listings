...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Listing.listingID'
        db.alter_column('listings_listing', 'listingID', self.gf('django.db.models.fields.BigIntegerField')(unique=True, primary_key=True))

    def backwards(self, orm):

        # Changing field 'Listing.listingID'
        db.alter_column('listings_listing', 'listingID', self.gf('django.db.models.fields.IntegerField')(unique=True, primary_key=True))
