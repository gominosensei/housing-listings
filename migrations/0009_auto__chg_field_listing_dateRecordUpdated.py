...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Listing.dateRecordUpdated'
        db.alter_column('listings_listing', 'dateRecordUpdated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Listing.dateRecordUpdated'
        db.alter_column('listings_listing', 'dateRecordUpdated', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
