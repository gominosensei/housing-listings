...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BadListing'
        db.create_table('listings_badlisting', (
            ('listingID', self.gf('django.db.models.fields.BigIntegerField')(unique=True, primary_key=True)),
        ))
        db.send_create_signal('listings', ['BadListing'])


    def backwards(self, orm):
        # Deleting model 'BadListing'
        db.delete_table('listings_badlisting')
