...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Listing.electricity'
        db.add_column('listings_listing', 'electricity',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Listing.heat'
        db.add_column('listings_listing', 'heat',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Listing.water'
        db.add_column('listings_listing', 'water',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Listing.electricity'
        db.delete_column('listings_listing', 'electricity')

        # Deleting field 'Listing.heat'
        db.delete_column('listings_listing', 'heat')

        # Deleting field 'Listing.water'
        db.delete_column('listings_listing', 'water')
    ...
    models = {
        'listings.listing': {
            ...
            'electricity': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'heat': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'water': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
