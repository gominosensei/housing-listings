...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Listing.electricity'
        db.alter_column('listings_listing', 'electricity', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Listing.water'
        db.alter_column('listings_listing', 'water', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Listing.heat'
        db.alter_column('listings_listing', 'heat', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'Listing.electricity'
        db.alter_column('listings_listing', 'electricity', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Listing.water'
        db.alter_column('listings_listing', 'water', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Listing.heat'
        db.alter_column('listings_listing', 'heat', self.gf('django.db.models.fields.NullBooleanField')(null=True))
