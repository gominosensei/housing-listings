...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Listing.sublet'
        db.alter_column('listings_listing', 'sublet', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Listing.shared'
        db.alter_column('listings_listing', 'shared', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Listing.deleted'
        db.alter_column('listings_listing', 'deleted', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'Listing.sublet'
        db.alter_column('listings_listing', 'sublet', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Listing.shared'
        db.alter_column('listings_listing', 'shared', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Listing.deleted'
        db.alter_column('listings_listing', 'deleted', self.gf('django.db.models.fields.NullBooleanField')(null=True))
