...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FreshListing'
        db.create_table('listings_freshlisting', (
            ('listingID', self.gf('django.db.models.fields.BigIntegerField')(unique=True, primary_key=True)),
        ))
        db.send_create_signal('listings', ['FreshListing'])


    def backwards(self, orm):
        # Deleting model 'FreshListing'
        db.delete_table('listings_freshlisting')
